...
public class Agente {
    ...
    private Agente() {
        ...
        try {
            ...
            System.out.println("Conexi�n con la base de datos realizada con exito");
    ...
    //M�todo para iniciar la conexion con la base de datos
    ...
    //M�todo para cerrar la conexion con la base de datos
    ...
    //M�todo para insertar registros en la base de dato.
    ...
    //M�todo para obtener varios elementos de una tabla.
    ...
    //M�todo para modificar las tablas.
    ...
    //M�todo para eliminar elementos de la base de datos
